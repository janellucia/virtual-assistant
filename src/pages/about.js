      ...
      <section className="about-page">
        ...
        <div className="about-wrap">
          ...
          <div className="text">
            ...
            {/* <p>My ideal client has a love for what they are doing—and is excited to create something that inspires and connects.</p> */}
            <p>I acknowledge I, live, work and play on the unceded, ancestral territories of the Haudenosaunee, Anishinabewaki, Mississaugas of the Credit First Nation, Mississauga, and the Wendake-Nionwentsïo nations.</p>
            <p>Design and business strategy in Toronto. For business inquiries, collaborations, press features or to simply say hi, please email <a href="mailto:hello@janellucia.com">hello@janellucia.com</a>.</p>
          </div>
        </div>
