    ...
    <div className="wrapper">
      <section className="about-page">
        ...
        <div className="about-wrap">
          ...
          <div className="text">
            <p>I specialize in logo design, brand identity, type-led graphic design and web design. I work with businesses to design unique experiences that connect to their audience with my Lean & Collaborative Design System <a href="/services">(LCDS).</a></p>
