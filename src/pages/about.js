      ...
      <section className="about-page">
        ...
        <div className="about-wrap">
          ...
          <div className="text">
            ...
            <p>As a designer, I love colours, layouts, images, and of course, sometimes more than anything, typography. In my opinion, typography is what transforms design into a beautiful work of art. It gives the design character (no pun intended). It evokes a feeling. This became the basis for my visual language and the way I solve problems. Sometimes it's effortless, sometimes complicated. Sometimes with lots of emotion, other times it's neutral, but good design expresses a certain feeling. And that's dictated by all kinds of things related to a project that makes it come to be.</p>
            <p>It might be that it's representing the architecture of a building, a restaurant or the whole spirit of a large, not-for-profit organisation or a bank – they're all different things that become expressed, but they're related by something that exists externally from the design.</p>
