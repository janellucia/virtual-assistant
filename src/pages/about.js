    ...
    <div className="wrapper">
      <section className="about-page">
        ...
        <div className="about-wrap">
          ...
          <div className="text">
            <p>I specialize in brand identity, logo design, type-led graphic design and web design. I work with businesses to design unique experiences that connect to their audience.</p>
