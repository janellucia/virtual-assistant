    ...
    <div className="wrapper">
      <section className="about-page">
        ...
        <div className="about-wrap">
          ...
          <div className="text">
            <p>I specialize in human-centred design, branding, website design, editorial design (books & magazines), and type-led graphic design. I aim to create design people feel connected to and I follow emotional design principles to put users at ease and understand their needs. My values are “Love More” and “Lead with Simplicity” these provide the foundation for all the work I produce.</p>
            <p>I’ve been designing since 2016, I started by creating logos and websites for people in my network and when I was ready to step it up, I completed Juno’s (formerly Hacker You) full-time front-end boot camp &amp; UX course. Along the way I’ve had some great opportunities to work with talented designers where I learned so much about simplicity, elegance, and how to effectively tell a story through design. I'm grateful for the community that has brought me to where I am.</p>
            ...
            <p>When I'm not pushing the boundaries of how big an Adobe file can be, I like to spend time with people I love, go to art galleries, restaurants, binge my fave series (right now it's The Politician), and take my dog Marvin out for walks.</p> <p>Send me an email if you're interested in working together. If you're in Toronto, let's grab coffee <a href="mailto:hello@janellucia.com">hello@janellucia.com</a></p>
          </div>
        </div>
