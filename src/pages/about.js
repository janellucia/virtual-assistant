    ...
    <div className="wrapper">
      <section className="about-page">
        ...
        <div className="about-wrap">
          ...
          <div className="text">
            <p>I aim to create design people feel connected to, I specialize in human centered design, branding, website design, editorial design (books &amp; magazines), and type-led graphic design. I follow emotional design principles to put users at ease and understand their needs, my values are “Love More” and “Lead with Simplicity” these provide a motivational foundation for all the work I produce.</p>
            <p>I’ve been designing since 2016, I started creating logos and websites for people in my network and after designing for a year, I became interested in coding, I completed Hacker You’s full time front-end bootcamp and then their UX course. After that, I got some great opportunities to work under some amazing designers where I learned so much about simplicity, elegance, and telling a story through design. Now, my clients and I work as a team to deliver compelling brands &amp; products through collaboration and storytelling. </p>
