    ...
    <div className="wrapper">
      <section className="about-page">
        ...
        <div className="about-wrap">
          ...
          <div className="text">
            <p>I specialize in human centered design, branding, website design and type-led graphic design. I love to learn about people and their behaviours and apply that knowledge to create beautiful and well-informed products people feel connected to. I follow emotional design principles to put users at ease and understand their needs. My core values are “Love More” and “Lead with Simplicity”, these values provide a motivational foundation for all the work that I produce.</p>
            <p>I've been practicing as a designer for four years and before that I was in the hair and beauty industry working as a business manager. Hair studios can be a lot like start-ups as they are extremely fast paced, and you tend to wear many hats, I would mainly focus on the financials, business strategy, marketing and team building. Part of that was to curate an online and social media presence for the business, I grew a huge passion for understanding customer needs and creating well informed marketing campaigns that delivered results.</p>
            <p>Ever since I can remember, I've been passionate about type and how to communicate through emotion. I started creating webpages for people in my network and immediately everything fell into place. After designing for a few months, I became interested in coding as a design tool, I completed Hacker You’s full time front-end bootcamp and then their UX course. Four years later my clients and I work as a team to deliver compelling brands and products with confidence. </p>
            <p>On top of my continued education, I attend meet ups, read books/articles and listen to podcasts but my most reliable tool for growth has always been working with other amazing designers – I learn so much by working with others and seeing how they approach design challenges. When I'm not working, I'm surrounding myself with friends and family, going to art galleries, and taking my dog Marvin Gaye for walks at Trinity Bellwoods.</p>
          </div>
        </div>
