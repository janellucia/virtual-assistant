      ...
      <section className="about-page">
        ...
        <div className="about-wrap">
          ...
          <div className="text">
            ...
            <p>I’ve been designing since 2016, I started by creating logos and websites for people in my network and when I was ready to go full time, I completed Juno’s (formerly Hacker You) full-time front-end boot camp &amp; UX course. Along the way, I’ve had amazing opportunities to work with some great designers where I learned so much about simplicity, elegance, and how to effectively tell a story through design. I'm grateful for my community that inspired me to be the best version of myself.</p>
