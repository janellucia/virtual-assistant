    ...
    <div className="wrapper">
      ...
      <section className="about-page">
        <div className="about-wrap links-wrap">
          ...
          <p>If you're looking to establish Diversity & Inclusion values into your business, check out my services and together we can define ethical, human standards at the core of your brand.</p>
          <div className="tabs">
            <div className="tab">
            ...
            <div className="tab">
              <a href="/" target="new" class="insta-links">janellucia.com</a>
            </div>
            <div className="tab">
              <a href="/about" target="new" class="insta-links">About</a>
            </div>
            <div className="tab">
              <a href="/services" target="new" class="insta-links">Services</a>
            </div>
            <div className="tab">
