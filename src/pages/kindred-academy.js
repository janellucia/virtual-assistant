  ...
  <Layout name="project-page">
    ...
    <div id="wicked-problem" className="wrapper">
      <section className="image-right">
          ...
          <Img fluid={props.data.imageOne.childImageSharp.fluid} alt="kindred academy design values – 1 keep it innovative, 2 know the goals, 3 keep it simple, 4 promote empathy, 5 keep it fresh, 6 be approachable" />
      </section>
      <section className="image-left mobile-reverse">
        <Img fluid={props.data.imageTwo.childImageSharp.fluid} alt="kindred academy 8 levels of learning - to learn more please open the presentation" />
        <div className="text-wrap">
      ...
      <div className="stand-alone-image">
        <Img fluid={props.data.imageThree.childImageSharp.fluid} alt="a day in the life of students at kindred academy – a typical saturday" />
      </div>
      <div className="stand-alone-image">
        <Img fluid={props.data.imageFour.childImageSharp.fluid} alt="kindred academy branding colours and merch" />
      </div>
    </div>
...
export const pageQuery = graphql`
  query {
    imageOne: file(relativePath: { eq: "wicked-problem/design-values-updated.png" }) {
      childImageSharp {
        fluid(maxWidth: 1000) {
    ...
    imageTwo: file(relativePath: { eq: "wicked-problem/8-levels.png" }) {
      childImageSharp {
        fluid(maxWidth: 1000) {
          ...GatsbyImageSharpFluid_noBase64
        }
    ...
    imageThree: file(relativePath: { eq: "wicked-problem/a-day-in-the-life.png" }) {
      childImageSharp {
        fluid(maxWidth: 1000) {
          ...GatsbyImageSharpFluid_noBase64
        }
    ...
    imageFour: file(relativePath: { eq: "wicked-problem/branding.png" }) {
      childImageSharp {
        fluid(maxWidth: 1000) {
          ...GatsbyImageSharpFluid_noBase64
        }
