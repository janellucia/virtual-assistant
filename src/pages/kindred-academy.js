  ...
  <Layout name="project-page">
    ...
    <section className="project-info intro">
        <div className="project-copy">
          <h2>Solving the wicked problem of increased anxiety in youth</h2>
          ...
          <h3>Role</h3>
          <p>I was the lead designer/researcher on this project. I created the Kindred Academy style guide &amp; business strategy.</p>
          <h3>The Challenge</h3>
          <p>Define a wicked problem and use research to explore solutions. </p>
          <h3>The Solution</h3>
          <p>Create a presentation to showcase a potential solution to a wicked problem with research, divergence &amp; transformation, and convergence &amp; solution.</p>
        </div>
      ...
      <section className="project-info intro">
        ...
        <div className="project-copy project-steps">
          <p>In the definition stage, I worked on clearly understanding the situation and context of youth mental health. I started off with some high-level research to prove that youth mental health is a significant problem.</p>
          <p>I found a growing body of scientific evidence tells us that emotional development begins early in life, that it is a critical aspect of the development of overall brain architecture, and that it has enormous consequences over the course of a lifetime.</p>
      ...
      <section className="project-info">
        ...
        <div className="project-copy project-steps">
          ...
          <p>I chose to interview a mix of kids &amp; parents from different cities and towns and different economic and educational backgrounds. In all groups, I found that through our differences families are experiencing similar frustrations, anxiety, stress and lack of communication and confidence. Though the children I interviewed were incredibly smart and adaptable they also expressed feelings of social isolation and a pressure to succeed academically, stressing over classes, grades and tests.</p>
          <p>It was clear understanding youth mental health is extremely complex, to be successful I need to create and follow well thought out design values to act as my north star, a guiding light in the midst of all the uncertainty. While researching and defining the design values, I also defined an empathy map so I have a clear understanding of the people on the other end of this wicked problem.</p>
        </div>
      ...
      <section className="project-info intro">
        <h2>Convergence</h2>
        <div className="project-copy project-steps">
          <p>Convergence is the final stage in the systematic design, it's where I narrow down and blend insights collected from research, divergence &amp; transformation.</p>
    ...
    <section className="project-links wicked-links">
      <div className="wrapper">
        ...
        <p className="subtitle">Kindred Academy offers after school and Saturday programs to support our youth into a more confident and compassionate future.</p>
        <div className="button-wrap">
          <a href="https://drive.google.com/file/d/1Z0o78m80WI0TZSK1xX2-Zu3RdLTSxMiW/view?usp=sharing" className="button" target="_blank" rel="noopener noreferrer">View Presentation</a>
        </div>
      </div>
